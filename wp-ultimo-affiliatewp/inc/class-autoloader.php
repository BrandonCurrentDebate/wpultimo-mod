<?php
/**
 * WP Ultimo: AffiliateWP Integration custom Autoloader.
 *
...
use WP_Ultimo_AffiliateWP\Dependencies\Pablo_Pacheco\WP_Namespace_Autoloader\WP_Namespace_Autoloader;
	...
	public static function init() {
		...
		if (!static::$instance instanceof static) {
			...
			static::$instance = new WP_Namespace_Autoloader(array(
				...
				'namespace_prefix'     => 'WP_Ultimo_AffiliateWP',
				'classes_dir'          => 'inc',
