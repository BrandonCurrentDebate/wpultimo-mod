<?php
/**
 * WP Ultimo - WooCommerce Gateways activation and deactivation hooks
 *
...
class Hooks {
	...
	/**
	 *  Runs when WP Ultimo - WooCommerce Gateways is activated
	 *
	...
	/**
	 * Runs when WP Ultimo - WooCommerce Gateways is deactivated
	 *
	 * @since 1.9.6 It now uses hook-based approach, it is up to each sub-class to attach their own routines.
	 * @since 1.2.0
	 */
