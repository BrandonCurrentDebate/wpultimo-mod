...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
     ...
     * We use this to generate a actions.md file containing all filters and hooks WP Ultimo Captcha has available.
     */
    todo: {
      actions: {
        options: {
          ...
          file: './actions.md',
          title: 'WP Ultimo Captcha - Actions and Filters',
          githubBoxes: false,
          colophon: true,
          usePackage: true,
        },
