...
class Updater {
    ...
    // Instantiating it
		...
		$url,                           // Metadata URL.
		WP_ULTIMO_CAPTCHA_PLUGIN_FILE,        // Full path to the main plugin file.
		'wp-ultimo-captcha'                   // Plugin slug. Usually it's the same as the name of the directory.
		);
