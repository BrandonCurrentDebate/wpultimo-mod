<?php
/**
 * WP Ultimo Captcha custom Autoloader.
 *
...
use WP_Ultimo_Captcha\Dependencies\Pablo_Pacheco\WP_Namespace_Autoloader\WP_Namespace_Autoloader;
	...
	public static function init() {
		...
		if (!static::$instance instanceof static) {
			...
			static::$instance = new WP_Namespace_Autoloader(array(
				...
				'namespace_prefix'     => 'WP_Ultimo_Captcha',
				'classes_dir'          => 'inc',
