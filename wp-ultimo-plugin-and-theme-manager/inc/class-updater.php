...
class Updater {
    ...
    // Instantiating it
		...
		$url,                           // Metadata URL.
		WP_ULTIMO_PLUGIN_AND_THEME_MANAGER_PLUGIN_FILE,        // Full path to the main plugin file.
		'wp-ultimo-plugin-and-theme-manager'                   // Plugin slug. Usually it's the same as the name of the directory.
		);
