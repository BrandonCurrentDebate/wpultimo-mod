<?php
/**
 * WP Ultimo Plugin And Theme Manager custom Autoloader.
 *
...
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Pablo_Pacheco\WP_Namespace_Autoloader\WP_Namespace_Autoloader;
	...
	public static function init() {
		...
		if (!static::$instance instanceof static) {
			...
			static::$instance = new WP_Namespace_Autoloader(array(
				...
				'namespace_prefix'     => 'WP_Ultimo_Plugin_And_Theme_Manager',
				'classes_dir'          => 'inc',
