...
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\Types\Void_;
 ...
 */
final class Method extends \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\DocBlock\Tags\BaseTag implements \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    /** @var string */
     ...
     */
    public function __construct(string $methodName, array $arguments = [], ?\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\Type $returnType = null, bool $static = \false, ?\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\DocBlock\Description $description = null)
    {
        \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Webmozart\Assert\Assert::stringNotEmpty($methodName);
        if ($returnType === null) {
            $returnType = new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\Types\Void_();
        }
        ...
        if ($argumentLines !== '') {
            ...
            foreach ($argumentsExploded as $argument) {
                ...
                if (\strpos($argument[0], '$') === 0) {
                    ...
                    $argumentType = new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\Types\Mixed_();
                } else {
    ...
    public function getReturnType() : \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\Type
    {
    ...
    private function filterArguments(array $arguments = []) : array
    {
        ...
        foreach ($arguments as $argument) {
            ...
            if (!isset($argument['type'])) {
                $argument['type'] = new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\Types\Mixed_();
            }
