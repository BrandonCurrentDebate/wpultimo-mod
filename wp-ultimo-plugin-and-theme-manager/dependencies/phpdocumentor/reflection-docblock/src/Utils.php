...
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\Exception\PcreException;
...
abstract class Utils
{
    ...
    public static function pregSplit(string $pattern, string $subject, int $limit = -1, int $flags = 0) : array
    {
        ...
        if ($parts === \false) {
            throw \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\phpDocumentor\Reflection\Exception\PcreException::createFromPhpError(\preg_last_error());
        }
        \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Webmozart\Assert\Assert::allString($parts);
        return $parts;
    }
}
