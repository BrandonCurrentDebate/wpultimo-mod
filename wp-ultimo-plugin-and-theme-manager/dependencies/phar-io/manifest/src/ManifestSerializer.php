...
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Version\AnyVersionConstraint;
...
class ManifestSerializer
{
    /** @var XMLWriter */
    private $xmlWriter;
    public function serializeToFile(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\Manifest $manifest, string $filename) : void
    {
        \file_put_contents($filename, $this->serializeToString($manifest));
    }
    public function serializeToString(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\Manifest $manifest) : string
    {
        $this->startDocument();
    ...
    private function addContains(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\ApplicationName $name, \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Version\Version $version, \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\Type $type) : void
    {
    ...
    private function addCopyright(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\CopyrightInformation $copyrightInformation) : void
    {
    ...
    private function addRequirements(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\RequirementCollection $requirementCollection) : void
    {
        $phpRequirement = new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Version\AnyVersionConstraint();
        $extensions = [];
        foreach ($requirementCollection as $requirement) {
            if ($requirement instanceof \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\PhpVersionRequirement) {
                $phpRequirement = $requirement->getVersionConstraint();
                continue;
            }
            if ($requirement instanceof \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\PhpExtensionRequirement) {
    ...
    private function addBundles(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\BundledComponentCollection $bundledComponentCollection) : void
    {
    ...
    private function addExtension(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Manifest\ApplicationName $applicationName, \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PharIo\Version\VersionConstraint $versionConstraint) : void
    {
