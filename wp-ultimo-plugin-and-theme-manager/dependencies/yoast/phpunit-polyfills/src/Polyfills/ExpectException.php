...
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Util_InvalidArgumentHelper;
/**
...
trait ExpectException
{
    ...
    public function expectExceptionCode($code)
    {
        if (!\is_int($code) && !\is_string($code)) {
            throw \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Util_InvalidArgumentHelper::factory(1, 'integer or string');
        }
    ...
    public function expectExceptionMessage($message)
    {
        if (!\is_string($message)) {
            throw \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Util_InvalidArgumentHelper::factory(1, 'string');
        }
