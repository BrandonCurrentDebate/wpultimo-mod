...
use Exception;
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_AssertionFailedError;
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test;
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_TestSuite;
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Warning;
/**
...
trait TestListenerDefaultImplementation
{
     ...
     */
    public function addError(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test $test, \Exception $e, $time)
    {
     ...
     * @param float                     $time Execution time of this test.
     */
    public function addWarning(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test $test, \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Warning $e, $time)
    {
     ...
     * @param float                                  $time Execution time of this test.
     */
    public function addFailure(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test $test, \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_AssertionFailedError $e, $time)
    {
     ...
     * @param float                  $time Execution time of this test.
     */
    public function addIncompleteTest(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test $test, \Exception $e, $time)
    {
     ...
     * @param float                  $time Execution time of this test.
     */
    public function addRiskyTest(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test $test, \Exception $e, $time)
    {
     ...
     * @param float                  $time Execution time of this test.
     */
    public function addSkippedTest(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test $test, \Exception $e, $time)
    {
     ...
     */
    public function startTestSuite(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_TestSuite $suite)
    {
     ...
     * @param PHPUnit_Framework_TestSuite $suite Test suite object.
     */
    public function endTestSuite(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_TestSuite $suite)
    {
     ...
     * @param PHPUnit_Framework_Test $test Test object.
     */
    public function startTest(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test $test)
    {
     ...
     * @param float                  $time Execution time of this test.
     */
    public function endTest(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Framework_Test $test, $time)
    {
