...
namespace WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Yoast\PHPUnitPolyfills;

use PHPUnit\Runner\Version as PHPUnit_Version;
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Runner_Version;
if (\class_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\Yoast\\PHPUnitPolyfills\\Autoload', \false) === \false) {
    /**
     * Custom autoloader.
     */
    class Autoload
    {
        ...
        public static function load($className)
        {
            ...
            if (\stripos($className, 'WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\Yoast\\PHPUnitPolyfills') !== 0) {
                return \false;
            }
            switch ($className) {
        ...
        public static function loadExpectException()
        {
             ...
             */
            if (\class_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Exception') === \true && \class_exists('PHPUnit\\Framework\\Exception') === \false) {
                \class_alias('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Exception', 'PHPUnit\\Framework\\Exception');
            }
        ...
        public static function loadExpectPHPException()
        {
             ...
             * which may be creating cross-version compatibility in a similar manner.}}
             */
            if (\class_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Error') === \true && \class_exists('PHPUnit\\Framework\\Error\\Error') === \false) {
                \class_alias('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Error', 'PHPUnit\\Framework\\Error\\Error');
            }
            if (\class_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Error_Warning') === \true && \class_exists('PHPUnit\\Framework\\Error\\Warning') === \false) {
                \class_alias('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Error_Warning', 'PHPUnit\\Framework\\Error\\Warning');
            }
            if (\class_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Error_Notice') === \true && \class_exists('PHPUnit\\Framework\\Error\\Notice') === \false) {
                \class_alias('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Error_Notice', 'PHPUnit\\Framework\\Error\\Notice');
            }
            if (\class_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Error_Deprecated') === \true && \class_exists('PHPUnit\\Framework\\Error\\Deprecated') === \false) {
                \class_alias('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Error_Deprecated', 'PHPUnit\\Framework\\Error\\Deprecated');
            }
        ...
        public static function loadTestListenerDefaultImplementation()
        {
            if (\version_compare(self::getPHPUnitVersion(), '6.0.0', '<')) {
                 ...
                 * which may be creating cross-version compatibility in a similar manner.}}
                 */
                if (\class_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Warning') === \true && \class_exists('PHPUnit\\Framework\\Warning') === \false) {
                    \class_alias('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Framework_Warning', 'PHPUnit\\Framework\\Warning');
                }
                // PHPUnit < 6.0.0.
        ...
        public static function getPHPUnitVersion()
        {
            ...
            if (\class_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\PHPUnit_Runner_Version')) {
                return \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHPUnit_Runner_Version::id();
            }
            return '0';
        }
    }
