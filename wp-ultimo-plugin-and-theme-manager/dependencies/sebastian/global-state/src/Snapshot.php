...
class Snapshot
{
     ...
     */
    public function __construct(\SebastianBergmann\GlobalState\Blacklist $blacklist = null, bool $includeGlobalVariables = \true, bool $includeStaticAttributes = \true, bool $includeConstants = \true, bool $includeFunctions = \true, bool $includeClasses = \true, bool $includeInterfaces = \true, bool $includeTraits = \true, bool $includeIniSettings = \true, bool $includeIncludedFiles = \true)
    {
        if ($blacklist === null) {
    ...
    public function blacklist() : \SebastianBergmann\GlobalState\Blacklist
    {
    ...
    private function enumerateObjectsAndResources($variable) : array
    {
        ...
        if (\is_array($variable)) {
            ...
            $result[] = $variable;
            foreach ((new \SebastianBergmann\ObjectReflector\ObjectReflector())->getAttributes($variable) as $value) {
