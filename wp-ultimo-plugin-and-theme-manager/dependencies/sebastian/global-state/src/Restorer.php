...
class Restorer
{
    ...
    {
        if (!\function_exists('WP_Ultimo_Plugin_And_Theme_Manager\\Dependencies\\uopz_delete')) {
            throw new \SebastianBergmann\GlobalState\RuntimeException('The uopz_delete() function is required for this operation');
        }
    ...
    {
        $current = new \SebastianBergmann\GlobalState\Snapshot($snapshot->blacklist(), \false, \false, \false, \false, \true, \false, \false, \false, \false);
