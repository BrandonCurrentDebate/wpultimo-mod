...
class Exporter
{
    ...
    {
        return $value !== null && \is_scalar($value) === \false && \is_array($value) === \false && \is_object($value) === \false;
    }
    /**
    ...
    private function isClosedResource($value)
    {
        ...
        if ($isNotNonResource === \true) {
            ...
            } catch (\SebastianBergmann\Exporter\TypeError $e) {
                // Ignore. Not a resource.
            } catch (\SebastianBergmann\Exporter\Exception $e) {
                // Ignore. Not a resource.
            }
        }
        return \false;
