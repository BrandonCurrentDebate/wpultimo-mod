...
final class Facade
{
    ...
    public function process(\SebastianBergmann\CodeCoverage\CodeCoverage $coverage, string $target) : void
    {
        ...
        $dashboard = new \SebastianBergmann\CodeCoverage\Report\Html\Dashboard($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
        $directory = new \SebastianBergmann\CodeCoverage\Report\Html\Directory($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
        $file = new \SebastianBergmann\CodeCoverage\Report\Html\File($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
    ...
    private function getDirectory(string $directory) : string
    {
        ...
        if (!$this->createDirectory($directory)) {
            throw new \SebastianBergmann\CodeCoverage\RuntimeException(\sprintf('Directory "%s" does not exist.', $directory));
        }
        return $directory;
    }
