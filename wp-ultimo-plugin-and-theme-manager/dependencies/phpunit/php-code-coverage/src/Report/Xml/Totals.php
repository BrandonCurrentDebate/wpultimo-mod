...
final class Totals
{
    ...
    public function setNumLines(int $loc, int $cloc, int $ncloc, int $executable, int $executed) : void
    {
        ...
        $this->linesNode->setAttribute('percent', $executable === 0 ? '0' : \sprintf('%01.2F', \SebastianBergmann\CodeCoverage\Util::percent($executed, $executable)));
    }
    public function setNumClasses(int $count, int $tested) : void
    {
        $this->classesNode->setAttribute('count', (string) $count);
        $this->classesNode->setAttribute('tested', (string) $tested);
        $this->classesNode->setAttribute('percent', $count === 0 ? '0' : \sprintf('%01.2F', \SebastianBergmann\CodeCoverage\Util::percent($tested, $count)));
    }
    public function setNumTraits(int $count, int $tested) : void
    {
        ...
        $this->traitsNode->setAttribute('percent', $count === 0 ? '0' : \sprintf('%01.2F', \SebastianBergmann\CodeCoverage\Util::percent($tested, $count)));
    }
    public function setNumMethods(int $count, int $tested) : void
    {
        ...
        $this->methodsNode->setAttribute('percent', $count === 0 ? '0' : \sprintf('%01.2F', \SebastianBergmann\CodeCoverage\Util::percent($tested, $count)));
    }
    public function setNumFunctions(int $count, int $tested) : void
    {
        ...
        $this->functionsNode->setAttribute('percent', $count === 0 ? '0' : \sprintf('%01.2F', \SebastianBergmann\CodeCoverage\Util::percent($tested, $count)));
    }
}
