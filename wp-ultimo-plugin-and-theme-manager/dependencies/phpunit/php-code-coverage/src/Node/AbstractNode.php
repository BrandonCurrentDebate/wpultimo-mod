...
abstract class AbstractNode implements \Countable
{
    ...
    {
        return \SebastianBergmann\CodeCoverage\Util::percent($this->getNumTestedClasses(), $this->getNumClasses(), $asString);
    }
    /**
    ...
    {
        return \SebastianBergmann\CodeCoverage\Util::percent($this->getNumTestedTraits(), $this->getNumTraits(), $asString);
    }
    /**
    ...
    {
        return \SebastianBergmann\CodeCoverage\Util::percent($this->getNumTestedClassesAndTraits(), $this->getNumClassesAndTraits(), $asString);
    }
    /**
    ...
    {
        return \SebastianBergmann\CodeCoverage\Util::percent($this->getNumTestedFunctions(), $this->getNumFunctions(), $asString);
    }
    /**
    ...
    {
        return \SebastianBergmann\CodeCoverage\Util::percent($this->getNumTestedMethods(), $this->getNumMethods(), $asString);
    }
    /**
    ...
    {
        return \SebastianBergmann\CodeCoverage\Util::percent($this->getNumTestedFunctionsAndMethods(), $this->getNumFunctionsAndMethods(), $asString);
    }
    /**
    ...
    {
        return \SebastianBergmann\CodeCoverage\Util::percent($this->getNumExecutedLines(), $this->getNumExecutableLines(), $asString);
    }
    /**
