...
final class File extends \SebastianBergmann\CodeCoverage\Node\AbstractNode
{
    ...
    public function __construct(string $name, \SebastianBergmann\CodeCoverage\Node\AbstractNode $parent, array $coverageData, array $testData, bool $cacheTokens)
    {
    ...
    {
        if ($this->cacheTokens) {
            $tokens = \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHP_Token_Stream_CachingFactory::get($this->getPath());
        } else {
            $tokens = new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHP_Token_Stream($this->getPath());
        }
    ...
    private function processClasses(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHP_Token_Stream $tokens) : void
    {
    ...
    private function processTraits(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHP_Token_Stream $tokens) : void
    {
    ...
    private function processFunctions(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHP_Token_Stream $tokens) : void
    {
