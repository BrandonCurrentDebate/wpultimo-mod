...
final class Directory extends \SebastianBergmann\CodeCoverage\Node\AbstractNode implements \IteratorAggregate
{
    ...
    {
        return new \RecursiveIteratorIterator(new \SebastianBergmann\CodeCoverage\Node\Iterator($this), \RecursiveIteratorIterator::SELF_FIRST);
    }
    /**
     ...
     */
    public function addFile(string $name, array $coverageData, array $testData, bool $cacheTokens) : \SebastianBergmann\CodeCoverage\Node\File
    {
        $file = new \SebastianBergmann\CodeCoverage\Node\File($name, $this, $coverageData, $testData, $cacheTokens);
        $this->children[] = $file;
