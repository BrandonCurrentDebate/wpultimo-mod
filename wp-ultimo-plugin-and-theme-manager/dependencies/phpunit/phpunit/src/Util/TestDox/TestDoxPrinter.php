...
class TestDoxPrinter extends \PHPUnit\TextUI\ResultPrinter
{
    ...
    public function endTest(\PHPUnit\Framework\Test $test, float $time) : void
    {
        ...
        if ($this->testHasPassed()) {
            $this->registerTestResult($test, null, \PHPUnit\Runner\BaseTestRunner::STATUS_PASSED, $time, \false);
        }
    ...
    {
        $this->registerTestResult($test, $t, \PHPUnit\Runner\BaseTestRunner::STATUS_ERROR, $time, \true);
    }
    /**
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    ...
    {
        $this->registerTestResult($test, $e, \PHPUnit\Runner\BaseTestRunner::STATUS_WARNING, $time, \true);
    }
    /**
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    ...
    {
        $this->registerTestResult($test, $e, \PHPUnit\Runner\BaseTestRunner::STATUS_FAILURE, $time, \true);
    }
    /**
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    ...
    {
        $this->registerTestResult($test, $t, \PHPUnit\Runner\BaseTestRunner::STATUS_INCOMPLETE, $time, \false);
    }
    /**
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    ...
    {
        $this->registerTestResult($test, $t, \PHPUnit\Runner\BaseTestRunner::STATUS_RISKY, $time, \false);
    }
    /**
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    ...
    {
        $this->registerTestResult($test, $t, \PHPUnit\Runner\BaseTestRunner::STATUS_SKIPPED, $time, \false);
    }
    ...
    {
        $testName = \PHPUnit\Runner\TestSuiteSorter::getTestSorterUID($test);
    ...
    protected function testHasPassed() : bool
    {
        ...
        if ($this->testResults[$this->testIndex]['status'] === \PHPUnit\Runner\BaseTestRunner::STATUS_PASSED) {
            return \true;
        }
        return \false;
    }
