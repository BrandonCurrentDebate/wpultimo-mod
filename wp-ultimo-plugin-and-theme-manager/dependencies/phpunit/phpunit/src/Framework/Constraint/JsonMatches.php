...
final class JsonMatches extends \PHPUnit\Framework\Constraint\Constraint
{
    ...
    protected function fail($other, $description, \SebastianBergmann\Comparator\ComparisonFailure $comparisonFailure = null) : void
    {
        if ($comparisonFailure === null) {
            ...
            $comparisonFailure = new \SebastianBergmann\Comparator\ComparisonFailure(\json_decode($this->value), \json_decode($other), \PHPUnit\Util\Json::prettify($recodedValue), \PHPUnit\Util\Json::prettify($recodedOther), \false, 'Failed asserting that two json values are equal.');
        }
