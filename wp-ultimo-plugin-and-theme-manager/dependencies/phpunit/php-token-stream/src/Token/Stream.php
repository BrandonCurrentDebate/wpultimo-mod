    ...
    public function getIncludes($categorize = \false, $category = null)
    {
        if ($this->includes === null) {
            ...
            foreach ($this->tokens as $token) {
                switch (\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHP_Token_Util::getClass($token)) {
            ...
            switch (\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHP_Token_Util::getClass($token)) {
                ...
                case 'PHP_Token_TRAIT':
                    ...
                    if ($token->getName() !== null) {
                        if ($token instanceof \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\PHP_Token_CLASS) {
                            $class[] = $token->getName();
