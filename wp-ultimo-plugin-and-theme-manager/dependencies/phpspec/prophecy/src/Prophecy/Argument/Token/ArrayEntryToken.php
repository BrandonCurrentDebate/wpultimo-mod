 ...
 */
class ArrayEntryToken implements \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Argument\Token\TokenInterface
{
    ...
    {
        return $value instanceof \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Argument\Token\TokenInterface ? $value : new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Argument\Token\ExactValueToken($value);
    }
    /**
    ...
    {
        if (!$this->key instanceof \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Argument\Token\ExactValueToken) {
            throw new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Exception\InvalidArgumentException(\sprintf('You can only use exact value tokens to match key of ArrayAccess object' . \PHP_EOL . 'But you used `%s`.', $this->key));
        }
