...
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Doubler\Generator\Node\TypeNodeAbstract;
/**
 * Class code creator.
...
{
    public function __construct(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Doubler\Generator\TypeHintReference $typeHintReference = null)
    {
    }
    /**
     ...
     * @return string
     */
    public function generate($classname, \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Doubler\Generator\Node\ClassNode $class)
    {
    ...
    private function generateMethod(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Doubler\Generator\Node\MethodNode $method)
    {
    ...
    private function generateTypes(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Doubler\Generator\Node\TypeNodeAbstract $typeNode) : string
    {
    ...
    {
        return \array_map(function (\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Doubler\Generator\Node\ArgumentNode $argument) {
