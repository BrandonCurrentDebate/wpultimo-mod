...
use WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Exception\Doubler\MethodNotExtendableException;
...
class ClassNode
{
    ...
    public function addProperty($name, $visibility = 'public')
    {
        ...
        if (!\in_array($visibility, array('public', 'private', 'protected'))) {
            throw new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Exception\InvalidArgumentException(\sprintf('`%s` property visibility is not supported.', $visibility));
        }
    ...
    public function addMethod(\WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Doubler\Generator\Node\MethodNode $method, $force = \false)
    {
        if (!$this->isExtendable($method->getName())) {
            $message = \sprintf('Method `%s` is not extendable, so can not be added.', $method->getName());
            throw new \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\Prophecy\Exception\Doubler\MethodNotExtendableException($message, $this->getParentClass(), $method->getName());
        }
