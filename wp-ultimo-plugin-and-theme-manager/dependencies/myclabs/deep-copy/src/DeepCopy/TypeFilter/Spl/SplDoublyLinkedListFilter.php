 ...
 * @final
 */
class SplDoublyLinkedListFilter implements \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\DeepCopy\TypeFilter\TypeFilter
{
    private $copier;
    ...
    private function createCopyClosure()
    {
        ...
        return \Closure::bind($copy, null, \WP_Ultimo_Plugin_And_Theme_Manager\Dependencies\DeepCopy\DeepCopy::class);
    }
}
