...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
     ...
     * We use this to generate a actions.md file containing all filters and hooks WP Ultimo Plugin And Theme Manager has available.
     */
    todo: {
      actions: {
        options: {
          ...
          file: './actions.md',
          title: 'WP Ultimo Plugin And Theme Manager - Actions and Filters',
          githubBoxes: false,
          colophon: true,
          usePackage: true,
        },
      ...
      todos: {
        options: {
          ...
          file: './todos.md',
          title: 'WP Ultimo Plugin And Theme Manager - Todos',
          githubBoxes: true,
          colophon: true,
          usePackage: true,
        },
